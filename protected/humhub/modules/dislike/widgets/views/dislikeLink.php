...
<span class="dislikeLinkContainer" id="dislikeLinkContainer_<?= $id ?>">
    ...
    <?php else: ?>
        <a href="#" data-action-click="dislike.toggleDislike" data-action-url="<?= $dislikeUrl ?>" class="dislike dislikeAnchor<?= !$canDislike ? ' disabled' : '' ?><?php echo $currentUserDisliked ? ' disliked' : ''; ?>" style="<?= (!$currentUserDisliked) ? '' : 'display:none'?>">
            <i class="fa fa-thumbs-down"></i>
        </a>
        <a href="#" data-action-click="dislike.toggleDislike" data-action-url="<?= $undislikeUrl ?>" class="undislike dislikeAnchor<?= !$canDislike ? ' disabled' : '' ?><?php echo $currentUserDisliked ? '' : ' undisliked'; ?>" style="<?= ($currentUserDisliked) ? '' : 'display:none'?>">
            <i class="fa fa-thumbs-down"></i>
        </a>
    <?php endif; ?>
