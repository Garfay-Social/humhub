...
<div class="panel-body">
    ...
    <p class="help-block"><?= Yii::t('AdminModule.user', 'Min value is 20 seconds. If not set, session will timeout after 86400 seconds (24 hours) regardless of activity (default session timeout)'); ?></p>
